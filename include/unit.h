//
// Created by andym on 8/19/2021.
//

#ifndef ANALYTICAL_MODELING_UNIT_H
#define ANALYTICAL_MODELING_UNIT_H
...
public:
    ...
    char getPrefix(double num);
};
//Do I need classes for units?
class second : unit{
...
#endif //ANALYTICAL_MODELING_UNIT_H
